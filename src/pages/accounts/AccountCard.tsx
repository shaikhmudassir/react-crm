  ...
  return (
    ...
    >
      ...
      <TableCell className="tableCell">
        ...
        >
          <Avatar
            src={accountInfo?.lead?.created_by?.profile_pic}
            alt={accountInfo?.lead?.created_by?.email}
          />
          <Stack sx={{ ml: 1 }}>
            {accountInfo?.lead?.account_name
              ? accountInfo?.lead?.account_name
              : '---'}
          </Stack>
        </Stack>
      ...
      <TableCell className="tableCell">
        {accountInfo?.tags?.length
          ? accountInfo?.tags.map((tag: any, i: any) => (
